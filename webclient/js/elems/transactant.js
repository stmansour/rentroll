...
window.buildTransactElements = function() {
    var transactantFields = [
        ...
        {field: 'CompanyName', type: 'text', required: false, html: {page: 0, column: 0}},
        {
            field: 'IsCompany',
            type: 'list',
            options: {items: app.companyOrPerson},
            required: true,
            html: {page: 0, column: 0}
        },
        ...
        {
            field: 'EligibleFutureUser',
            type: 'list',
            options: {items: app.yesNoList},
            required: false,
            html: {page: 1, column: 0}
        },
        ...
        {
            field: 'EligibleFuturePayor',
            type: 'list',
            options: {items: app.yesNoList},
            required: false,
            html: {page: 2, column: 0}
        },
        ...
        {field: 'EmployerCity', type: 'text', required: false, html: {page: 3, column: 0}},
        {
            field: 'EmployerState',
            type: 'list',
            options: {items: app.usStateAbbr},
            required: false,
            html: {page: 3, column: 0}
        },
