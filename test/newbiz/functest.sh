...
mysqlverify "f1" "-e rcpt.csv ${RRCTX}"     "PaymentAllocations"	    	"select RCPTID,BID,RAID,Dt,Amount,ASMID,AcctRule from ReceiptAllocation order by Amount ASC;"
mysqlverify "g1" " "                   		"Receipts"	            		"select RCPTID,BID,PMTID,DID,Dt,Amount,AcctRule,Comment,LastModBy from Receipt;"
