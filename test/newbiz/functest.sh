...
mysqlverify "j"     "Depositories"	            	"select DEPID,BID,LID,Name,AccountNo,LastModBy from Depository;"
...
mysqlverify "p"     "Payors"	                	"select TCID,CreditLimit,LastModBy from Payor;"
...
mysqlverify "m"     "RentableUseStatus"	        	"select RID,UseStatus,DtStart,DtStop,LastModBy from RentableUseStatus;"
...
mysqlverify "x"     "ChartOfAccounts"	    		"select LID,PLID,BID,RAID,GLNumber,Name,AcctType,AllowPost,LastModBy from GLAccount;"
mysqlverify "xa"    "AccountRules"	    			"select ARID,BID,Name,ARType,DebitLID,CreditLID,Description,LastModBy from AR;"
...
mysqlverify "f1"    "ReceiptAllocations"	    	"select RCPTID,BID,RAID,Dt,Amount,ASMID,AcctRule from ReceiptAllocation order by Amount ASC;"
