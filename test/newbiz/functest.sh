...
dotest "t"  "-r rentable.csv"     "PHASE  7: Rentables...  " "select RID,RTID,BID,Name,AssignmentTime,RentalPeriodDefault,RentCycle,LastModBy from Rentable;"
dotest "t1" "-r rentable.csv"     "PHASE  8: RentableRTID...  " "select RID,RTID,DtStart,DtStop,LastModBy from RentableRTID;"
...
dotest "o"  "-T rat.csv"          "PHASE 14: Rental Agreement Templates...  " "select RATID,RentalTemplateNumber,RentalAgreementType,LastModBy from RentalAgreementTemplate;"
...
dotest "n1" "-E pet.csv"          "PHASE 16: Pets...  " "select PETID,RAID,Type,Breed,Color,Weight,Name,DtStart,DtStop,LastModBy from AgreementPets;"
dotest "m"  "-C ra.csv"           "PHASE 17: Agreement Rentables...  " "select * from AgreementRentables;"
dotest "l"  "-C ra.csv"           "PHASE 18: Agreement Payors...  " "select * from AgreementPayors;"
...
dotest "j"  "-A asmt.csv"         "PHASE 21: Assessments...  " "select ASMID,BID,RID,ASMTID,RAID,Amount,Start,Stop,RentCycle,ProrationMethod,AcctRule,Comment,LastModBy from Assessments;"
