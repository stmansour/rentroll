...
// this holds the window object of current page
let windowObject;
    ...
    ************************************************************/
    it('Record Detail Form', function () {
        ...
        if(noRecordsInAPIResponse >0){
            ...
            // appSettings: app variable of application
            // windowObject: it is a object of current window
            common.testDetailFormWithGrid(recordsAPIResponse, testConfig, appSettings, windowObject);
