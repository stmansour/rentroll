...
export let conf = {
    ...
    skipColumns: [],
    skipFields: ["ApplyRcvAccts", "RAIDrqd", "PriorToRAStart", "PriorToRAStop", "AutoPopulateToNewRA", "IsRentASM", "IsNonRecurCharge", "IsSecDepASM"], //TODO(Akshay): Write UI test for checkboxes
    primaryId: "ARID"
};
