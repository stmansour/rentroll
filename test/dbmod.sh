...
ALTER TABLE rentroll.Prospect MODIFY TCID BIGINT NOT NULL DEFAULT 0, DROP PRIMARY KEY, ADD ProspectID BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY;
ALTER TABLE rentroll.User MODIFY TCID BIGINT NOT NULL DEFAULT 0, DROP PRIMARY KEY, ADD UserID BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY;
ALTER TABLE rentroll.Payor MODIFY TCID BIGINT NOT NULL DEFAULT 0, DROP PRIMARY KEY, ADD PayorID BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY;
