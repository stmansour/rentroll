...
CREATE TABLE `AvailabilityTypes` (
  ...
  `Name` varchar(100) NOT NULL DEFAULT '',
  `LastModTime` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `LastModBy` bigint(20) NOT NULL DEFAULT '0',
  `CreateTS` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `CreateBy` bigint(20) NOT NULL DEFAULT '0',
  PRIMARY KEY (`AVAILID`)
...
INSERT INTO `RentalAgreementRentables` VALUES (1,2,1,1,0,3750.0000,'2014-03-01','2018-03-01','2018-01-10 18:32:35',0,'2017-11-30 18:20:15',0),(2,3,1,2,0,4000.0000,'2016-10-01','2018-01-01','2018-01-10 18:32:35',0,'2017-11-30 18:32:13',0),(3,4,1,3,0,4150.0000,'2016-07-01','2018-07-01','2018-01-10 18:32:35',0,'2017-11-30 18:34:33',0);
...
-- Dump completed on 2018-03-16 15:12:09
