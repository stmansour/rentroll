...
mysqlverify "q"  "${RRCTX}"		"Prospects"	            		"select TCID,EmployerName,CompanyAddress,CompanyCity,CompanyState,CompanyPostalCode,CompanyEmail,CompanyPhone,Occupation,ApplicationFee,LastModBy from Prospect;"
