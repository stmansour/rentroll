...
CREATE TABLE `RentalAgreement` (
  ...
  `FLAGS` bigint(20) NOT NULL DEFAULT '0',
  `ApplicationFilledBy` bigint(20) NOT NULL DEFAULT '0',
  `ApplicationFilledDate` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  ...
  `MoveInDecisionDate` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
  `ActiveUID` bigint(20) NOT NULL DEFAULT '0',
  `ActiveDecisionDate` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
...
-- Dump completed on 2018-07-27 18:12:21
