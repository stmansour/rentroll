...
pushd ../importers/onesite/onesite_exported_2;./functest.sh -n -f; ../../../../tmp/rentroll/rrloadcsv -c coa.csv -ar ar.csv -noauth; popd
pushd ../importers/roomkey/roomkey_exported_guest;./functest.sh -n -f; ../../../../tmp/rentroll/rrloadcsv -c coa.csv -ar ar.csv -noauth; popd
