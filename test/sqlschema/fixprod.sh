...
-- July 18, 2018
ALTER TABLE AR ADD DefaultRentCycle SMALLINT NOT NULL DEFAULT 0 AFTER DefaultAmount;
ALTER TABLE AR ADD DefaultProrationCycle SMALLINT NOT NULL DEFAULT 0 AFTER DefaultRentCycle;
