...
dojsonPOST "http://localhost:8270/v1/flow/1/1/" "request" "a2"  "RAFlow-add_new_person"

# REQUEST TO CREATE NEW ENTRY FOR A PET
echo "%7B%22cmd%22%3A%22new%22%2C%22FlowID%22%3A1%7D" > request
dojsonPOST "http://localhost:8270/v1/raflow-pets/1/1/" "request" "a3" "RAFlow-create_new_pet_entry"
...
dojsonPOST "http://localhost:8270/v1/flow/1/1/" "request" "a4" "RAFlow-update_new_pet_info"

# REQUEST TO CREATE NEW ENTRY FOR A VEHICLE
echo "%7B%22cmd%22%3A%22new%22%2C%22FlowID%22%3A1%7D" > request
dojsonPOST "http://localhost:8270/v1/raflow-vehicles/1/1/" "request" "a5" "RAFlow-create_new_vehicle_entry"
...
dojsonPOST "http://localhost:8270/v1/flow/1/1/" "request" "a6" "RAFlow-update_new_vehicle_info"
...
# dojsonPOST "http://localhost:8270/v1/raflow-person/1/1/" "request" "a2"  "RAFlow-add_person_TCID_3"
