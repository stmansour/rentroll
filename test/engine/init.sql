...
INSERT INTO Assessments (BID,RID,ATypeLID,RAID,Amount,Start,Stop,RecurCycle,ProrationCycle, AcctRule) VALUES
	...
	(1, 1, 31, 8,1500.00,"2015-11-21", "2015-11-21", 0, 0, "d ${GLSECDEPRCV} _, c ${GLSECDEPASMT} _");		-- #8 Simpson deposit
...
-- =======================================================================
INSERT INTO Assessments (BID,RID,ATypeLID,RAID,Amount,Start,Stop,RecurCycle,ProrationCycle, AcctRule) VALUES
	(1, 1, 24, 1,250.00,"2015-11-08","2015-11-08", 0, 0, "d ${GLSECDEPASMT} _, c 42006 _"),	-- #12  Krabappel, $250 damages
	(1, 1, 31, 1,750.00,"2015-11-08","2015-11-08", 0, 0, "d ${GLSECDEPASMT} _, c 10001 _");
...
INSERT INTO Receipt (BID,RAID,PMTID,Dt,Amount,AcctRule) VALUES
	(1,1,2,"2004-01-01", 1000.00, "d ${GLCASH} _, c 11002 _");			-- 1  Krabappel's initial security deposit
INSERT INTO ReceiptAllocation (RCPTID,Amount,ASMID,AcctRule) VALUES
	(1,1000.00,7, "d ${GLCASH} 1000.00, c 11002 1000.00");		

INSERT INTO Receipt (BID,RAID,PMTID,Dt,Amount,AcctRule) VALUES
	(1,1,1,"2015-11-21",  294.66, "ASM(1) c ${GLGENRCV} 266.67, ASM(1) d ${GLCASH} 266.67, ASM(3) c ${GLGENRCV} 13.33, ASM(3) d ${GLCASH} 13.33, ASM(4) c ${GLGENRCV} 5.33, ASM(4) d ${GLCASH} 5.33, ASM(9) c ${GLGENRCV} 9.33,ASM(9) d ${GLCASH} 9.33"); 			-- 2   Krabappel pays her fees in full
INSERT INTO ReceiptAllocation (RCPTID,Amount,ASMID,AcctRule) VALUES
...
INSERT INTO Receipt (BID,RAID,PMTID,Dt,Amount,AcctRule) VALUES
	(1,8,1,"2015-11-30",1946.68, "d ${GLCASH} 1500.00, c 11002 1500.00, c ${GLGENRCV} 400.00, d ${GLCASH} 400.00, c ${GLGENRCV} 16.67, d ${GLCASH} 16.67, c ${GLGENRCV} 6.67, d ${GLCASH} 6.67, c ${GLGENRCV} 11.67,d ${GLCASH} 11.67, c ${GLGENRCV} 11.67,d ${GLCASH} 11.67");  			-- 3   Simpson pays his fees in full
INSERT INTO ReceiptAllocation (RCPTID,Amount,ASMID,AcctRule) VALUES
...
INSERT INTO LedgerMarker (BID,LID,State,DtStart,DtStop,Balance) VALUES
	...
	(1,36,3,"2015-10-01","2015-10-31",0.0),
	(1,37,3,"2015-10-01","2015-10-31",0.0),
	(1,38,3,"2015-10-01","2015-10-31",0.0),
	(1,39,3,"2015-10-01","2015-10-31",0.0);
