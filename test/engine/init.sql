...
INSERT INTO Receipt (BID,RAID,PMTID,Dt,DocNo,Amount,AcctRule) VALUES
	(1,1,2,"2004-01-01", "2301", 1000.00, "d ${GLCASH} _, c 11002 _");			-- 1  Krabappel's initial security deposit
...
INSERT INTO Receipt (BID,RAID,PMTID,Dt,DocNo,Amount,AcctRule) VALUES
	(1,8,1,"2015-11-30","8330",1946.68, "d ${GLCASH} 1500.00, c 11002 1500.00, c ${GLGENRCV} 400.00, d ${GLCASH} 400.00, c ${GLGENRCV} 16.67, d ${GLCASH} 16.67, c ${GLGENRCV} 6.67, d ${GLCASH} 6.67, c ${GLGENRCV} 11.67,d ${GLCASH} 11.67, c ${GLGENRCV} 11.67,d ${GLCASH} 11.67");  			-- 3   Simpson pays his fees in full
INSERT INTO ReceiptAllocation (RCPTID,Amount,ASMID,AcctRule) VALUES
