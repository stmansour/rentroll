...
# create Assessment from 1st Jan 2016 to 1st Jul 2016 with all instances, with contract Rent at 3000$
...
dojsonPOST "http://localhost:8270/v1/asm/1/0" "request" "ws401"  "WebService--AddAssessments-01Jan2016-01Jan2017"

# create Assessment from 1st Jul 2016 to 1st Jan 2017 with all instances, with contract Rent at 3000$
