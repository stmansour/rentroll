...
func RRReportTable(ri *ReporterInfo) gotable.Table {
	...
	//==========================
	rentablesRows, err := ws.GetRentRollReportPartSQLRows("rentables", ri.Bid,
		startDt, stopDt,
		"", "", -1, -1)
	...
	for rentablesRows.Next() {
		...
		rentablesAsmtRows, err := ws.GetRentRollReportPartSQLRows("rentablesAsmt", ri.Bid,
			startDt, stopDt,
		...
		rentablesNoAsmtRows, err := ws.GetRentRollReportPartSQLRows("rentablesNoAsmt", ri.Bid,
			startDt, stopDt,
	...
	//====================================
	noRIDAsmtRows, err := ws.GetRentRollReportPartSQLRows("noRIDAsmt", ri.Bid,
		startDt, stopDt,
		"", "", -1, -1)
	...
	//=======================================
	noRIDNoAsmtRows, err := ws.GetRentRollReportPartSQLRows("noRIDNoAsmt", ri.Bid,
		startDt, stopDt,
		"", "", -1, -1)
