...
type Assessment struct {
	...
	/* FLAGS
	 * bits 0-1: 0 = unpaid,1 = partially paid, 2 = fully paid, 3 = it's an offset, do not apply payments to this assessment
	 * 1<<2:  1 = this assmt has been reversed.
	 * 1<<3:  PETID required
	 * 1<<4:  VID required
	 */
	FLAGS       uint64    // bits as defined in comment above
	Comment     string    //
	LastModTime time.Time //
	LastModBy   int64     //
	CreateTS    time.Time // when was this record created
...
type RRprepSQL struct {
	...
	GetRentableLeaseStatus                  *sql.Stmt
	GetRentableLeaseStatusByRange           *sql.Stmt
	...
	UpdateFlowPartData                      *sql.Stmt // flow table
	...
	GetAllRentableLeaseStatus               *sql.Stmt
	...
	GetRentableLeaseStatusOnOrAfter         *sql.Stmt
