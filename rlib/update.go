...
func UpdatePayor(ctx context.Context, a *Payor) error {
	...
	fields := []interface{}{
		a.BID,
		a.CreditLimit,
		t, // encrypted TaxpayorID
		a.EligibleFuturePayor,
		a.FLAGS,
		d, // encrypted DriversLicense
		a.GrossIncome,
		a.LastModBy,
		a.TCID,
	}
...
func UpdateRentableLeaseStatus(ctx context.Context, a *RentableLeaseStatus) error {
	...
	fields := []interface{}{a.RID, a.BID, a.RAID, a.DtStart, a.DtStop, a.LeaseStatus, a.Comment, a.FirstName, a.LastName, a.Email, a.Phone, a.Address, a.Address2, a.City, a.State, a.PostalCode, a.Country, a.CCName, a.CCType, a.CCNumber, a.CCExpMonth, a.ConfirmationCode, a.LastModBy, a.RLID}
