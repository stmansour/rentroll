...
func InsertRentableLeaseStatus(ctx context.Context, a *RentableLeaseStatus) (int64, error) {
	...
	// transaction... context
	fields := []interface{}{a.RID, a.BID, a.DtStart, a.DtStop, a.LeaseStatus, a.Comment, a.FirstName, a.LastName, a.Email, a.Phone, a.Address, a.Address2, a.City, a.State, a.PostalCode, a.Country, a.CCName, a.CCType, a.CCNumber, a.CCExpMonth, a.CreateBy, a.LastModBy}
	if tx, ok := DBTxFromContext(ctx); ok { // if transaction is supplied
