...
func InsertAR(a *AR) (int64, error) {
	var rid = int64(0)
	res, err := RRdb.Prepstmt.InsertAR.Exec(a.BID, a.Name, a.ARType, a.DebitLID, a.CreditLID, a.Description, a.RARequired, a.DtStart, a.DtStop, a.CreateBy, a.LastModBy)
	if nil == err {
...
func InsertLedger(l *GLAccount) (int64, error) {
	var rid = int64(0)
	//                                            PLID, BID,     RAID,  TCID,   GLNumber,   Status,    Type,   Name,   AcctType,   AllowPost, RARequred,     FLAGS,   Description, CreateBy, LastModBy
	res, err := RRdb.Prepstmt.InsertLedger.Exec(l.PLID, l.BID, l.RAID, l.TCID, l.GLNumber, l.Status, l.Type, l.Name, l.AcctType, l.AllowPost, l.RARequired, l.FLAGS, l.Description, l.CreateBy, l.LastModBy)
	if nil == err {
		id, err := res.LastInsertId()
		if err == nil {
			rid = int64(id)
